...
const NoteMe = React.createClass({
  ...
  render() {
    return (
      <div className="note_me" style={cssDisplay(this.props.show)}>
          ...
          <div className="con">
            ...
            <div className="mood">
              ...
              <ul>
                ...
                <li><img src="/public/img/mood2.png" style={{
        marginTop: "5px"
      }} alt=""/></li>
                <li><img src="/public/img/mood3.png" style={{
        marginTop: "7px"
      }} alt=""/></li>
                <li><img src="/public/img/mood4.png" style={{
        marginTop: "5px"
      }} alt=""/></li>
              </ul>
            </div>
